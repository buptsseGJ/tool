					...
					for (int j = 0; j < raceList.getLength(); j++) {
						...
						if(raceList.item(j).getNodeType()!=Node.TEXT_NODE){
							if (raceList.item(j).hasChildNodes()) {
								...
								String line1 = tempLine1.getFirstChild().getNodeValue()!=null?(tempLine1.getFirstChild().getNodeValue()
										.toString()).trim():null;
								String line2 = tempLine2.getFirstChild().getNodeValue()!=null?(tempLine2.getFirstChild().getNodeValue()
										.toString()).trim():null;
								...
								String detail = tempDetail.getFirstChild().getNodeValue()!=null?tempDetail.getFirstChild().getNodeValue().toString().trim():null;
